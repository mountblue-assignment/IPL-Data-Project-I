...
const writeDataToJsonFile= require('./utility/writeDataToJsonFile');
...
writeDataToJsonFile(totalMatchesPerYear,'./src/public/output/matchesPerYear.json');


//for matches won per team per year ------------

const totalWinnersTeamPerYear=matchesWonPerTeamPerYear(matchesData);
writeDataToJsonFile(totalWinnersTeamPerYear,'./src/public/output/matchesWonPerTeamPerYear.json');
...
writeDataToJsonFile(extraRunConcededPerTeamData,'./src/public/output/extraRunConcededPerTeam.json');


// Top 10 economical bowlers in the year 2015 ----------

const top10EconomicalBowlersData=top10EconomicalBowlers(deliveriesData,matchesData);
writeDataToJsonFile(top10EconomicalBowlersData,'./src/public/output/top10EconomicalBowlers.json');
...
writeDataToJsonFile(wonTossWonMatchTeamData,'./src/public/output/wonTossWonMatchTeam.json');


// Find a player who has won the highest number of Player of the Match awards for each season -----------

const highestNoOfPlayerOfMatchData=highestNoOfPlayerOfMatch(matchesData);
writeDataToJsonFile(highestNoOfPlayerOfMatchData,'./src/public/output/highestNoOfPlayerOfMatch.json');


// Find the highest number of times one player has been dismissed by another player----------------

const highestDismissedByAnotherPlayerData=highestDismissedByAnotherPlayer(deliveriesData);
writeDataToJsonFile(highestDismissedByAnotherPlayerData,'./src/public/output/highestDismissedByAnotherPlayer.json');


//Find the strike rate of a batsman for each season-------------

const batsmanStrikeRatePerSeasonData=batsmanStrikeRatePerSeason(matchesData,deliveriesData);
writeDataToJsonFile(batsmanStrikeRatePerSeasonData,'./src/public/output/batsmanStrikeRatePerSeason.json');
...
writeDataToJsonFile(bowlerWithBestEconomySuperoverData,'./src/public/output/bowlerWithBestEconomySuperover.json');
